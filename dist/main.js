...
document.addEventListener("DOMContentLoaded", () => {
    const addForAllButton = document.getElementById("add-for-all");
    const addForCurrentButton = document.getElementById("add-for-current");
    const status = document.getElementById("status");
    const selectorsTextarea = document.getElementById("selectors-textarea");
            ...
            document.querySelectorAll(".remove-button").forEach((button) => {
                button.addEventListener("click", (e) => {
                    ...
                    if (domain && selectorToRemove) {
                        ...
                        selectorMap[domain] = selectorMap[domain].filter((s) => s !== unescapedSelector);
                        if (domain !== "general" &&
